						...
						<table border="0" align="center" cellspacing="10">
							...
							<tr>
								...
								<td colspan="2" align="center">
									<div id="facultyimg"><img id="fimg" src="faculty photos/<?php echo $data['upload'];?>" height="200px" width="200px"/></div>
								</td>
							</tr>
							...
							<tr>
								...
								<td>
									<div class="field"><?php echo $data['s_name']." ".$data['name'];?></div>
								</td>
							</tr>
							<tr>
								<td>
								...
								<td>
									<div class="field"><?php echo $data['address'];?></div>
								</td>
							</tr>
							<tr>
								<td>
								...
								<td>
									<div class="field"><?php echo $data['email'];?></div>
								</td>
							</tr>
							<tr>
								<td>
								...
								<td>
									<div class="field"><?php echo $data['mobile_no'];?></div>
								</td>
							</tr>
					...
					<tr>
						<td colspan="4">
							<?php
								...
								$query="select * from attendance where fid=$fid";
								...
								$month=date('m');
								$number = cal_days_in_month(CAL_GREGORIAN, $month, 2017);
										for($a=1;$a<=$number;$a++){
										$cdate=$a."-04-2017";
											if(in_array($cdate,$darray))
											{
											?>
												<div class="gblock">
												<?php
